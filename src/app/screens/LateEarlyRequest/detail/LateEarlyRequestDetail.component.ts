...
@Component({
  ...
  templateUrl: './LateEarlyRequestDetail.component.html',
  styleUrls: ['./LateEarlyRequestDetail.component.scss']
})
export class LateEarlyRequestDetailComponent implements OnInit {
  ...
  constructor(
    ...
    private router: Router,public commonHandler: CommonHandlerService,
...
eventOnPleaseReject() {
  ...
  this.api.post(API_LATEEARLY.Alias_RejectRequestLateEarlyRequest, API_LATEEARLY.RejectRequestLateEarlyRequest,
    {
    ...
    .subscribe(result => {
        ...
        if (result && !result.IsError) {
          ...
          this.notification.alert(this.Lang.COMMON.Alert,this.Lang.NOTIFY.UpdateSuccess,null,null,['btnReject']);
