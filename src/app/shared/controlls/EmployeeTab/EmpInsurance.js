...
class EmpInsurance extends Component {
                    ...
                    <CardItem header bordered style={styleLeave.header}>
                        <TouchableOpacity style={styleLeave.headerContent} onPress={this.toggleShowHide}>
                            <View style={styleGroup.titleContainer}>
                                <Text style={styleGroup.title}>{HrmI18n.t('EMPLOYEEINFO.EmpInsurance')}</Text>
                            </View>
            ...
            <View style={styles.itemContainer} onPress={this.props.onPress} activeOpacity={1}>
                <View style={styleGroup.flexColumn}>
                    <View style={styleGroup.twoColumn}>
                        <Text style={[styleGroup.detailTitle, styleGroup.flexStart]}>{HrmI18n.t('EMPLOYEEINFO.SIBook')}</Text>
                        <Text style={[styleGroup.detailValue, styleGroup.flexEnd]}>{item.SIBook}</Text>
                    </View>
                    <View style={styleGroup.twoColumn}>
                        <Text style={[styleGroup.detailTitle, styleGroup.flexStart]}>{HrmI18n.t('EMPLOYEEINFO.WorkCenterName')}</Text>
                        <Text style={[styleGroup.detailValue, styleGroup.flexEnd]}>{item.WorkCenterName}</Text>
                    </View>
...
export default connect(mapStateToProps)(EmpInsurance);
