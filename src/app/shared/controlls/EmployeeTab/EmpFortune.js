...
class EmpFortune extends Component {
                    ...
                    <CardItem header bordered style={styleLeave.header}>
                        <TouchableOpacity style={styleLeave.headerContent} onPress={this.toggleShowHide}>
                            <View style={styleGroup.titleContainer}>
                                <Text style={styleGroup.title}>{HrmI18n.t('EMPLOYEEINFO.EmpFortune')}</Text>
                            </View>
            ...
            <View style={styles.itemContainer} onPress={this.props.onPress} activeOpacity={1}>
                <View style={styleGroup.flexColumn}>
                    <View style={styleGroup.twoColumn}>
                        <Text style={[styleGroup.detailTitle, styleGroup.flexStart]}>{HrmI18n.t('EMPLOYEEINFO.FortuneName')}</Text>
                        <Text style={[styleGroup.detailValue, styleGroup.flexEnd]}>{item.FortuneName}</Text>
                    </View>
                    <View style={styleGroup.twoColumn}>
                        <Text style={[styleGroup.detailTitle, styleGroup.flexStart]}>{HrmI18n.t('EMPLOYEEINFO.ValueFortune')}</Text>
                        <Text style={[styleGroup.detailValue, styleGroup.flexEnd]}>{FormatHandler.formatNum(item.ValueFortune, this.props.LoginInfo, 'p')}</Text>
                    </View>
                    <View style={styleGroup.twoColumn}>
                        <Text style={[styleGroup.detailTitle, styleGroup.flexStart]}>{HrmI18n.t('EMPLOYEEINFO.ManagedBy')}</Text>
                        <Text style={[styleGroup.detailValue, styleGroup.flexEnd]}>{item.ManagerName}</Text>
                    </View>
                    <View style={styleGroup.twoColumn}>
                        <Text style={[styleGroup.detailTitle, styleGroup.flexStart]}>{HrmI18n.t('EMPLOYEEINFO.ReceivedDate')}</Text>
                        <Text style={[styleGroup.detailValue, styleGroup.flexEnd]}>{FormatHandler.formatDate(item.ReceivedDate, this.props.LoginInfo)}</Text>
                    </View>
                    <View style={styleGroup.twoColumn}>
                        <Text style={[styleGroup.detailTitle, styleGroup.flexStart]}>{HrmI18n.t('EMPLOYEEINFO.UsedTime')}</Text>
                        <Text style={[styleGroup.detailValue, styleGroup.flexEnd]}>{item.UsedTime}</Text>
                    </View>
                    <View style={styleGroup.twoColumn}>
...
export default connect(mapStateToProps)(EmpFortune);
